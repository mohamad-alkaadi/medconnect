...
const RecentClinicalEncounters = () => {
  return (
    <div className="bg-white rounded-lg px-6 py-7 lg:max-w-[850px] lg:flex-auto max-lg:w-full h-fit max-h-[80vh] shadow-sm">
      ...
      <div className="border-l-2 border-slate-100 overflow-auto ">
